...
//Beacon event which is send any delay, the content of the message is beacon or wsa evt
...
void DemoBaseApplLayer::handleSelfMsg(cMessage* msg)
{
    ...
    default: {
        std::cout<<"ENvia un mensaje raro \n";
