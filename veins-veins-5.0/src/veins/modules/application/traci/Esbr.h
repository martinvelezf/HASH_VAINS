...
typedef vector<DemoSafetyMessage*> DemoSafetyMessages;
typedef vector<TraCIDemo11pMessage*> TraCIDemo11pMessages;
...
class VEINS_API Esbr : public DemoBaseApplLayer {
public:
...
protected:
    ...
    map<long,TraCIDemo11pMessages> receivedMessageMap;    // treeId, onWSM vector
    vector<DemoSafetyMessage*>  neighbors;
    list<string>          junctionIds;
    map<string,Coord> junctionMap;
